...
export async function up(knex) {
  ...
  const matriks = {
    'Admin': [
      'risiko:daftar', 'risiko:lihat', 'risiko:nilai', 'risiko:lulus', 'risiko:padam',
      'rawatan:urus', 'pemantauan:urus', 'pindaan:urus', 'pindaan:lulus',
      'pengguna:urus', 'log:baca', 'log:padam', 'notifikasi:urus',
      'laporan:jana', 'dashboard:lihat', 'rujukan:urus',
    ],
    'Executive': [
      'risiko:daftar', 'risiko:lihat', 'risiko:nilai', 'risiko:lulus', 'risiko:padam',
      'rawatan:urus', 'pemantauan:urus', 'pindaan:urus', 'pindaan:lulus',
      'log:baca', 'notifikasi:urus', 'laporan:jana', 'dashboard:lihat',
    ],
    'Ketua Subsidiari': [
      'risiko:daftar', 'risiko:lihat', 'risiko:nilai', 'risiko:padam',
      'rawatan:urus', 'pemantauan:urus', 'pindaan:urus',
      'log:baca', 'notifikasi:urus', 'laporan:jana', 'dashboard:lihat',
    ],
    'Staff': [
      'risiko:daftar', 'risiko:lihat',
      'rawatan:urus', 'pemantauan:urus', 'pindaan:urus',
      'log:baca', 'notifikasi:urus', 'laporan:jana', 'dashboard:lihat',
    ],
    'Viewer': [
      'risiko:lihat', 'log:baca', 'notifikasi:urus', 'laporan:jana', 'dashboard:lihat',
    ],
  };
