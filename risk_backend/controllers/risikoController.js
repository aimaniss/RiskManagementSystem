...
// ------------------- POST: Tambah Risiko -------------------
export const tambahRisiko = async (req, res) => {
...
// ===============================================================
export const kemaskiniRawatanRisiko = async (req, res) => {
  const client = await pool.connect();
  const user = req.user;
  const { risiko_id } = req.params;
...
// ===============================================================
export const kemaskiniLogPemantauanRisiko = async (req, res) => {
  const client = await pool.connect();
  ...
  try {
    ...
    if (!tahun_pemantauan || !status_pemantauan) {
      client.release();
      return res.status(400).json({ error: "Medan wajib tidak lengkap" });
    }
...
// ------------------- PUT: Update Risiko -------------------
export const kemaskiniRisiko = async (req, res) => {
  const client = await pool.connect();
...
export const padamRisiko = async (req, res) => {
...
export const semakNoRujukan = async (req, res) => {
  try {
...
export const semakPenduaRisiko = async (req, res) => {
  try {
...
export const luluskanRisiko = async (req, res) => {
  const client = await pool.connect();
  try {
    const { risiko_id } = req.params;
    const user = req.user;
...
export const tolakRisiko = async (req, res) => {
  try {
    const { risiko_id } = req.params;
