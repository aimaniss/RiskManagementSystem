 ...
 * -------------------------------------------------------
 */
export const senaraiRisikoUntukPindaan = async (req, res) => {
  try {
    const user = req.user;
 ...
 * -------------------------------------------------------
 */
export const mohonPindaan = async (req, res) => {
  ...
  try {
    ...
    if (hasPenilaianInputChange) {
      ...
      const afterScore =
        kiraTahapRisiko(completeFinalData.skor_kebarangkalian, completeFinalData.skor_impak) ?? "-";
      if (
 ...
 * -------------------------------------------------------
 */
export const senaraiPindaan = async (req, res) => {
  try {
 ...
 * -------------------------------------------------------
 */
export const luluskanPindaan = async (req, res) => {
 ...
 * -------------------------------------------------------
 */
export const tolakPindaan = async (req, res) => {
  const { pindaan_id } = req.params;
