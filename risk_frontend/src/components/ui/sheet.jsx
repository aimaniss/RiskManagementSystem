...
const sheetVariants = cva(
  "fixed z-50 flex flex-col bg-background shadow-xl transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
/** Kandungan drawer; satu-satunya bahagian yang boleh skrol */
...
const SheetFooter = ({ className, ...props }) => (
  <div
    className={cn(
      "flex shrink-0 flex-wrap items-center justify-end gap-2 border-t bg-background px-5 py-3 sm:px-6",
      className
    )}
    {...props}
  />
