...
export default function EditPemantauan({ isOpen, risk, onClose }) { 
    ...
    const [data, setData] = useState({
        ...
        status_risiko: "", 
        status_risiko_desc: "",
        justifikasi_pindaan_penilaian: "", // ⭐️ DIUBAH: Nama state disamakan dengan DB
    });
    ...
    const fetchLog = async (risikoId) => {
        ...
        try {
            // Panggil 'sejarah' yang telah dikemaskini
    ...
    useEffect(() => {
        ...
        const initialData = {
            ...
            status_risiko: "",
            status_risiko_desc: "",
            // ⭐️ DIUBAH: Gunakan nama kolum DB yang betul
            justifikasi_pindaan_penilaian: risk.justifikasi_pindaan_penilaian || "-", 
        };
            ...
            <div className="pemantauan-modal-container" style={{ maxWidth: '1200px', width: '95%' }}> 
                ...
                <div className="pemantauan-modal-body"> 
                    ...
                    <div className="pemantauan-box">
                        ...
                        <div className="pemantauan-flex-row" style={{ marginBottom: '20px' }}>
                        ...
                        <div className="pemantauan-flex-row" style={{ marginBottom: '20px', borderTop: '1px solid #e5e7eb', paddingTop: '20px' }}> 
                            <div className="pemantauan-flex-item" style={{ flex: "2 1 300px" }}>
                                <span className="pemantauan-label-inline">Risiko:</span>
                                <span className="pemantauan-data-inline">{data.risiko || "-"}</span>
                            </div>
                            <div className="pemantauan-flex-item">
                                <span className="pemantauan-label-inline">Kategori Risiko:</span>
                                <span className="pemantauan-data-inline">{data.kategori || "-"}</span>
                            </div>
                            <div className="pemantauan-flex-item">
                                <span className="pemantauan-label-inline">Bahagian/Unit:</span>
                                <span className="pemantauan-data-inline">{data.bahagian || "-"}</span>
                            </div>
                        </div>
                    ...
                    <div className="pemantauan-box">
                        ...
                        <div className="pemantauan-flex-row pemantauan-score-row">
                            ...
                            <div className="pemantauan-score-card"><span className="pemantauan-score-label">Skor Risiko</span>
                        ...
                        <div className="pemantauan-flex-row" style={{ marginTop: '15px', borderTop: '1px solid #e2e8f0', paddingTop: '15px' }}>
                            <div className="pemantauan-flex-item" style={{ display: 'flex', flexDirection: 'column', flex: "1 1 100%" }}>
                                <span className="pemantauan-label-inline" style={{ fontWeight: 'bold', marginBottom: '5px' }}>Pindaan Penilaian:</span>
                                <span style={{ color: '#475569', fontSize: '0.9rem', whiteSpace: 'pre-wrap' }}>
                                    {/* ⭐️ DIUBAH: Guna nama state yang betul */}
                    ...
                    <div className="pemantauan-box">
                        ...
                        <div className="pemantauan-flex-row" style={{ padding: '18px 16px' }}>
                            <div className="pemantauan-flex-item">
                    ...
                    <div className="pemantauan-box">
                       <div className="pemantauan-box-header pemantauan-log-header">
                        ...
                        <button 
                            ...
                            onClick={() => { setLogToEdit(null); setIsTambahLogModalOpen(true); }} 
                        >
                                        ...
                                        <tbody>
                                            {logData.length > 0 ? (
                                                logData.map((log, index) => {
                                                    ...
                                                    // ⭐️ DIUBAH: Guna skor_risiko_pemantauan (teks) yang disimpan
                                                    ...
                                                    return (
                                                        <tr key={log.log_id || index}> 
                                                            ...
                                                            {/* ⭐️ DIUBAH: Guna nama kolum DB yang betul */}
                                                            <td data-label="PINDAAN KEBERKESANAN" style={{ maxWidth: '200px', whiteSpace: 'normal' }}>{log.justifikasi_pindaan_pemantauan || '-'}</td> 
                                                ...
                                                <tr>
                                                    <td colSpan="14" style={{ textAlign: 'center', color: '#64748b' }}>Tiada rekod log pemantauan yang direkodkan lagi.</td>
                                                </tr>
                                            )}
                                        </tbody>
                                    </table>
