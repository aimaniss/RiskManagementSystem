...
import { X, BookOpen, Loader2, Trash2, PlusCircle, Pencil } from "lucide-react"; // ✅ Import 'Pencil' untuk butang edit
...
                          </div>
                            ...
                                   <div className="pemantauan-box">
                                ...
                                {/* BEKAS FLEX UTAMA: Untuk 2 lajur besar (Kiri dan Kanan) */}
                                <div className="pemantauan-flex-row" style={{ padding: '18px 16px' }}>

                                    {/* LAJUR KIRI: Strategi Kawalan dan Pelan Tindakan */}
                                    <div className="pemantauan-flex-item">
                                    ...
                                    {/* LAJUR KANAN: Tempoh Jangkaan Siap dan Kakitangan Bertanggungjawab */}
                                    <div className="pemantauan-flex-item">
...
                    {/* 5. PAPARAN LOG SEJARAH PEMANTAUAN  */}
                    <div className="pemantauan-box">
