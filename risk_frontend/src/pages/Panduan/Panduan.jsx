...
// 🌟 BARU DITAMBAH: Data untuk Jadual 7
const statusPemantauanData = [
    { status: 'Buka', penerangan: 'Risiko baru yang telah dikenal pasti dan menunggu diambil tindakan' },
    { status: 'Sedang Dilaksanakan', penerangan: 'Risiko dalam proses mitigasi/pengurangan' },
    { status: 'Pemantauan', penerangan: 'Risiko dalam proses mitigasi/pengurangan sedang dalam pemantauan' },
    { status: 'Selesai', penerangan: 'Risiko yang telah diselesaikan melalui pelan tindakan dan Lembaga Pengarah bersetuju dengannya' },
    { status: 'Tutup', penerangan: 'Risiko ditutup/tidak relevan/ditolak' },
];
        ...
        <div className="rawatan-modal-overlay"> 
            <div className="panduan-container"> 
                ...
                <div className="panduan-content"> 
                    ...
                    {/* 🌟 BARU DITAMBAH: Jadual 7: Status Pemantauan */}
                    <section className="panduan-section">
                        <h3 className="panduan-section-title">Jadual 7: Status Pemantauan</h3>
                        <table className="panduan-table">
                            <thead>
                                <tr>
