...
function DaftarRisiko() {
  ...
  // Calculate skorRisiko, tahapRisiko & statusRisiko
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.noRujukan || !formData.tahun || !formData.subsidiari) {
      alert("⚠️ Sila lengkapkan maklumat penting.");
      return;
    }
    ...
    console.log("📦 Data dihantar:", finalData);
    ...
    try {
      ...
      setFormData({
        ...
        kategori: "", bahagian: "", risiko: "", skorKebarangkalaian: "",
