...
|--------|------|--------------------|
| 2026-09-26 | Log masuk | Halaman log masuk dua panel: kiri biru padu (logo besar, nama sistem & unit sahaja), kanan borang terus di atas latar putih (tajuk 28px, medan & butang 46px, teks bantuan dua baris di bawah garis pemisah), butang biru tua & kaki halaman versi; pada telefon hanya borang berlogo; panel gradien, teks promosi & kotak "Ingat saya" (tidak berfungsi) dibuang. Gaya medan/butang dikongsi dengan Tukar Kata Laluan. E2E **99/99** |
