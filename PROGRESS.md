...
|--------|------|--------------------|
| 2026-09-26 | Log Aktiviti & sidebar | **Log Aktiviti** direka semula: jadual dikelompok ikut hari, lencana aktiviti berikon & berwarna (`constants/jenisAktiviti.js`, dikongsi tab Sejarah), bar tapisan padat (julat pantas Hari ini/7/30 hari/tersuai), "Sembunyikan log masuk/keluar" lalai (API `sorokSesi`), kad pada telefon, Sheet butiran. **Sidebar** berlatar kelabu-biru lembut (terpisah daripada kandungan putih) dengan menu berkumpulan Utama/Risiko/Pentadbiran, item aktif biru padu, lencana bilangan Senarai Tugasan, Log Keluar merah berbingkai. **Mod gelap Tailwind** kini ikut kelas `.dark` (`@custom-variant dark`) — sebelum ini `dark:` ikut tetapan OS. Tajuk halaman 22px. E2E **99/99** |
