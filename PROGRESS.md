...
|--------|------|--------------------|
| 2026-09-26 | Log masuk | Halaman log masuk gaya portal rasmi: bar atas (logo UKM Holdings + nama sistem & unit), satu kad borang di tengah berjalur biru tua, butang biru tua institusi, kaki halaman versi; panel gradien, teks promosi & kotak "Ingat saya" (tidak berfungsi) dibuang. Gaya medan/butang dikongsi dengan Tukar Kata Laluan. E2E **99/99** |
