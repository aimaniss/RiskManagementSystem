...
|--------|------|--------------------|
| 2026-09-26 | Log masuk | Halaman log masuk dua panel: kiri biru padu (logo besar, nama sistem & unit sahaja), kanan borang ringkas dengan butang biru tua & kaki halaman versi; pada telefon hanya borang berlogo; panel gradien, teks promosi & kotak "Ingat saya" (tidak berfungsi) dibuang. Gaya medan/butang dikongsi dengan Tukar Kata Laluan. E2E **99/99** |
