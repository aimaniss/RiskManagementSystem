...
|--------|------|--------------------|
| 2026-09-26 | Tipografi | Tajuk halaman (`PageHeader`) guna Poppins (utiliti `font-heading`, sepadan jenama log masuk), 26px; deskripsi kelabu lembut. Inter & Poppins dimuat sekali di `index.html` (import fon berselerak dalam CSS halaman & Roboto yang tidak digunakan dibuang) |
